                    ...
                    <div class="card-body p-4">
                        <div class="d-flex flex-column flex-lg-row justify-content-lg-between gap-3 align-items-lg-start mb-3">
                            <div>
                                ...
                                <p class="text-secondary small mb-0">Admin can save the bot token here for the local polling worker. No public webhook is required.</p>
                            </div>
                            <div class="small text-secondary">
                        ...
                        <form method="post" class="row g-3 align-items-end">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-control bg-body-tertiary text-break">C:\xampp\php\php.exe telegram-poll.php</div>
                                <div class="form-text">Run this from the project folder to listen for Telegram messages on the local machine.</div>
                            </div>
                        ...
                        <?php if (!$telegramBotReady): ?>
                            <p class="small text-danger mb-0 mt-3">Save a bot token here first, then start the local polling command.</p>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
